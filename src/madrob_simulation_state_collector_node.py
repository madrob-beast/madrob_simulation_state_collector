...
from madrob_simulation_state_collector.srv import MadrobDoorDummy
...
def restartSim(ebws):
    ...
    arg1 = noforce # since now the force is controlled by the gazebo "simple door" plugin
...
def main(args):
     ...
     rospy.init_node('madrob_simulation_state_collector', anonymous=True) #CHECK IF REMOVE 'PROVIDER'
